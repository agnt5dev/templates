export const CONTEXT_BUILDER_USER_PROMPT = `Gather comprehensive context for this code review:
...
export const SYNTHESIZER_USER_PROMPT = `
<instructions>
...
export const FILE_REVIEWER_SYSTEM_PROMPT = `You are an expert code reviewer. You review a single file's diff in the context of a pull request.
...
export const FILE_REVIEWER_USER_PROMPT = `Review this file change in the context of the pull request.
...
export const SECURITY_REVIEWER_SYSTEM_PROMPT = `You are a security engineer performing a dedicated security review of a pull request.
...
export const SECURITY_REVIEWER_USER_PROMPT = `Perform a security review of this pull request.
...
export const REPORT_SYNTHESIZER_SYSTEM_PROMPT = `You are a senior engineering lead writing the final code review report.
...
export const REPORT_SYNTHESIZER_USER_PROMPT = `Generate the final code review report from these inputs.
