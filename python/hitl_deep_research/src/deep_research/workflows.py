...
2. [HITL] User approval of research plan before proceeding
...
allowing users to review and approve/reject the plan before research begins.
"""
...
async def deep_research_workflow(
    ...
    4. Write - Writing Agent synthesizes report and evaluates quality
...
Do you approve this research plan to proceed with research?"""
    ...
    # Handle edit case - get user's modified plan
    if decision == "edit":
        ctx.logger.info("User chose to edit the research plan")
        research_plan = await ctx.wait_for_user(
            question="Please provide your edited research plan:",
            input_type="text",
        )
    ...
    # Stage 4: Write Report & Evaluate
    ctx.logger.info("Stage 4: Writing report and evaluating quality")
