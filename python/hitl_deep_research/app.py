...
from deep_research.tools import fetch_webpage_tool, wikipedia_search_tool,analyze_research_findings_tool
...
async def main():
    ...
    try:
        worker = Worker(
            ...
            tools=[fetch_webpage_tool, wikipedia_search_tool,analyze_research_findings_tool],
        )
